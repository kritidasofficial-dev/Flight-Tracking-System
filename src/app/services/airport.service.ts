...
export class AirportService {
  private airports: Airport[] = [
    { code: 'JFK', name: 'John F. Kennedy International', city: 'New York', country: 'USA', coordinates: { lat: 40.6413, lng: -73.7781 } },
    { code: 'LAX', name: 'Los Angeles International', city: 'Los Angeles', country: 'USA', coordinates: { lat: 33.9425, lng: -118.4081 } },
  ...
  getAirports(): Observable<Airport[]> { return of(this.airports); }
  getAirportByCode(code: string): Observable<Airport | undefined> { return of(this.airports.find(a => a.code === code)); }
  getUniqueCodes(): Observable<string[]> { return of([...new Set(this.airports.map(a => a.code))]); }
}